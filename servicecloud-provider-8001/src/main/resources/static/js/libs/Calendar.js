...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = ' <tr>';
	_cs[_cs.length] = '  <th colspan="2"><input type="button" class="b" name="clearButton" id="clearButton" disabled="disabled" \/><\/th>';
...
document.writeln('<div id="__calendarPanel" style="position:absolute;display:none;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:220px;height:230px;">');
...
__ci.document.writeln('select {font-size:12px;background-color:#EFEFEF;cursor:pointer;}');
...
__ci.document.writeln('td.sat {color:#0000FF;background-color:#EFEFEF;cursor:pointer;}');
__ci.document.writeln('td.sun {color:#FF0000;background-color:#EFEFEF;cursor:pointer;}');
__ci.document.writeln('td.normal {background-color:#EFEFEF;cursor:pointer;}');
__ci.document.writeln('input.l {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:20px;cursor:pointer;}');
__ci.document.writeln('input.r {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:20px;cursor:pointer;}');
__ci.document.writeln('input.b {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:100%;height:20px;cursor:pointer;}');
__ci.document.writeln('-->');
